...
$lang = array_merge($lang, array(
	'ACP_POSTS_MERGING'				=> 'Mesclagem de posts',
	'ACP_POSTS_MERGING_EXPLAIN'		=> 'Aqui você pode aplicar as configurações da extensão Mesclagem de posts.',
	...
	'MERGE_NO_TOPICS_EXPLAIN'		=> 'Lista de ID dos tópicos, separado por vírgula, onde o recurso não será aplicado. Essa opção será aplicada somente se o recurso de mesclar posts estiver ativado.',
	...
	'MERGE_SEPARATOR_EXPLAIN'		=> 'Aqui você pode configurar o separador que será exibido entre os posts mesclados.<br />Você poderá usar BBCodes de acordo com as configurações do fórum ou configuração de mensagens.<br /><br />Você também pode usar qualquer string de idioma dos arquivos do pacote de idioma: {L_<em>&lt;STRINGNAME&gt;</em>} onde <em>&lt;STRINGNAME&gt;</em> é o nome da string traduzida que você quer adicionar. Por exemplo, {L_WROTE} será exibido como “escreveu”.<br /><br />Use o marcador <em>&#37;s</em> (apenas uma vez) para incluir o horário entre o separador dos posts mesclados.',
));
